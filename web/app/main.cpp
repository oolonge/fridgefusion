#include "presentation/forms/mainwindow.h"
...
int main(int argc, char *argv[])
{
    ...
    qDebug() << "Файл конфигурации:" << config.getConfigFilePath();
    qDebug() << "Подключение к БД:" << config.getDbHost() << ":" << config.getDbPort() << "/" << config.getDbName();
